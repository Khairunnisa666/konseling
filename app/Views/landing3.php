            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item"><a href="<?php echo base_url('') ?>" class='sidebar-link'><i class="bi bi-grid-fill"></i><span>Tentang PIKMA Patriot</span></a>
                        </li>

                        <li class="sidebar-item has-sub"><a href="#" class='sidebar-link'><i class="bi bi-cloud-arrow-up-fill"></i><span>Mulai Konseling</span></a>
                            <ul class="submenu ">
                                <li class="submenu-item "><a href="<?php echo base_url('') ?>">Buat Janji Konseling</a></li>
                                <li class="submenu-item "><a href="<?php echo base_url('') ?>">Kontak Admin</a></li>
                            </ul>
                        </li>


                        <li class="sidebar-item has-sub"><a href="#" class='sidebar-link'><i class="bi bi-cloud-arrow-up-fill"></i><span>Status Data</span></a>
                            <ul class="submenu ">
                                <li class="submenu-item "><a href="<?php echo base_url('') ?>">Jadwal Konseling</a></li>
                                <li class="submenu-item "><a href="<?php echo base_url('') ?>">Riwayat Konseling</a></li>
                                <li class="submenu-item "><a href="<?php echo base_url('') ?>">Rating Konselor</a></li>
                            </ul>
                        </li>
