...
<head>
    ...
    <title>Login - Sistem Informasi E-Counseling</title>
    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <h1 class="auth-title">Layanan Konseling PIKMA Patriot</h1>
                    <p class="auth-subtitle mb-5">Silahkan masukkan ID pengguna yang benar</p>
